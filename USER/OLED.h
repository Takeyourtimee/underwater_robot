...
#define OLED_SCLK_Clr() {GPIO_ResetBits(GPIOB,GPIO_Pin_8);delay_us(4);}//SCL
#define OLED_SCLK_Set() {GPIO_SetBits(GPIOB,GPIO_Pin_8);delay_us(4);}
 
#define OLED_SDIN_Clr() {GPIO_ResetBits(GPIOB,GPIO_Pin_9);delay_us(4);}//SDA
#define OLED_SDIN_Set() {GPIO_SetBits(GPIOB,GPIO_Pin_9);delay_us(4);}
